...
export const metadata: Metadata = {
  title: {
    default: "JA Homes | Luxury Sustainable Real Estate",
    template: "%s | JA Homes",
  },
  description: "JA Homes crafts exquisite sustainable sanctuaries and luxury real estate in Odisha, India. Explore premium residential projects, book private tours, and co-design your dream estate.",
  keywords: ["luxury real estate", "sustainable homes", "JA Homes", "Odisha real estate", "premium residential", "Phulnakhara", "Om Sai Ashraya", "biophilic design", "luxury architecture"],
  authors: [{ name: "JA Homes" }],
  creator: "JA Homes",
  publisher: "JA Homes",
  robots: {
    index: true,
  ...
  openGraph: {
    type: "website",
    locale: "en_IN",
    url: "https://jahomes.in",
    siteName: "JA Homes",
    title: "JA Homes | Luxury Sustainable Real Estate",
    description: "Exquisite sustainable sanctuaries and luxury real estate in Odisha, India.",
    images: [
      {
        url: "https://res.cloudinary.com/pctbshnp/image/upload/v1783009909/Logo_Dark_b6gafy.png?v=2",
        width: 1200,
        height: 630,
        alt: "JA Homes Luxury Real Estate",
      },
    ],
  },
  twitter: {
    ...
    title: "JA Homes | Luxury Sustainable Real Estate",
    description: "Exquisite sustainable sanctuaries and luxury real estate in Odisha, India.",
    images: ["https://res.cloudinary.com/pctbshnp/image/upload/v1783009909/Logo_Dark_b6gafy.png?v=2"],
  },
  icons: {
